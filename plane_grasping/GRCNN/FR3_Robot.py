...
class FR3_Robot:
    def __init__(self, hostname="192.168.10.1", username="franka", password="franka123", workspace_limits=None,
        ...
        self.cam_intrinsics = np.array([607.08178711,0,327.77697754,
                                        0,606.78900146,243.71188354,
                                        0,0,1]).reshape(3,3)
