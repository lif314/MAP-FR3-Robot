...
from ..grasp_model import LanguageGraspModel

from .albef import utils as utils
...
class LGDM(LanguageGraspModel):
    ...
    def _init_albef(self):
        ...
        args.config = 'models/plane_grasping/LGD/models/lgdm/albef/configs/Grounding.yaml'
